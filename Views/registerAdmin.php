<!-- In this VIEW we can register an Admin completing a form -->
               ...
               <div class="container">
                    <div class="grid"> 
                         <div class="form_login">
                              ...
                              <div class="form">
                                   <form action="<?php echo FRONT_ROOT ?>User/SignUpAdm"  method="post" class="login-form bg-dark-alpha p-5 bg-light">
                                   <?php
                                             if(isset($error)){
                                                  switch ($error) {
                                                       case "01":
